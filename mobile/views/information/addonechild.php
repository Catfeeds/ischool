<div class="row heard-list-waper">
    ...
    <div class="col-xs-2 col-xs-offset-1 text-align-l"> 
      <div onclick="backto('<?php echo URL_PATH?>/information/myallchild?openid=<?php echo \yii::$app->view->params['openid']?>')">
...
<div class="page-off" id="page-two">
    ...
    <div class="row edit-user-row" id="classna">
      <div class="col-xs-4 edit-user-top">   
          <i class="fa fa-user"></i> 姓名   
      </div>
       <div class="col-xs-7 text-align-l">

          <input type="text" autocomplete="off" placeholder="请输入学生姓名.." class="form-control" id="student"/>
...
<div class="row register-user-container times-display">
           <div class="col-xs-12 register-user-center-margin">
               ...
               <div class="row examine-user-list">
                     ...
                     <div class="col-xs-5 col-xs-offset-1 save-page off" onclick="addOneChild()">
