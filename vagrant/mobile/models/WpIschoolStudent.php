...
class WpIschoolStudent extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ctime', 'cid', 'type', 'sid', 'LastTime', 'LastStatus', 'enddate', 'upendtime', 'enddatejx', 'upendtimejx', 'enddateqq', 'upendtimeqq', 'enddateck', 'upendtimeck', 'enddatepa', 'upendtimepa', 'is_deleted'], 'integer'],
