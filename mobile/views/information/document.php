    ...
    <div class="row header-menu" id="header-menu1">
      ...
      <div class="col-xs-12">
        <div class="col-xs-3 jxt_op_btnol" id="back-btn">
              <a style="color:white;" href="<?php echo URL_PATH?>/information/index?openid=<?php echo \yii::$app->view->params['openid']?>&sid=<?php echo \yii::$app->view->params['sid']?>"><span class="fa fa-reply"></span>返回</a>
         </div> 
      
        <div class="col-xs-3 pull-right">
          <div name="/information/document-inbox?openid=<?php echo \yii::$app->view->params['openid']?>&qunzu=<?= $qunzu;?>" class="jxt_op_btn jxt_current_btn" id="receive_btn">全部文档</div>
        </div>
        <div class="col-xs-3 pull-right">
          <div name="/information/document-outbox?openid=<?php echo \yii::$app->view->params['openid']?>&qunzu=<?= $qunzu;?>" class="jxt_op_btn" id="sent_btn">我上传的</div>
        </div>
      </div>
    </div>
  </div>
