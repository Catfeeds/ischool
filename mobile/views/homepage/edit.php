...
<!-- 校园公告 --> 
  <div class="container-fluid list-container">
     <div class="row list-location">
         ...
         <div class="col-xs-10">
            <input type="text" class="form-control input-sm title-input-text" placeholder="请输入主题信息.." name="title" id="title"  value="<?php echo $title?>">
         </div>
     </div> 
  </div>
 <div class="container-fluid list-container">
     <div class="row list-location">
         ...
         <div class="col-xs-10">
            <input type="text" class="form-control input-sm title-input-text" placeholder="请输入主题信息.." name="title" id="sketch" value="<?php echo $sketch?>">
         </div>
     </div> 
  </div>
  ...
  <div class="panel panel-default content-margin">
    <div class="panel-collapse collapse in">
      <div class="panel-body">
        <div class="row">
          <div class="col-xs-12">
            <textarea class="form-control" rows="13" placeholder="请输入内容信息.."  id="txt-content" name="content"><?php echo $content?></textarea>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row file-bg">
    <div class="col-xs-6">
      <div class="add-img">
        ...
        <img src="<?php echo $toppicture?:"/img/add_img.png"?>" id="img">
      </div>
    </div>
    <div class="col-xs-6">
      <div class="file-btn" onclick="file_input()">上传封面</div>
       <input id="upload-input" accept="image/*"  type="file" name="upload-input" style="display:none">
    </div>
  </div>
  ...
  else
  {
    ...
    if(first == true)
    {
      ...
      first = false;
         ...
         $.ajax({
          url:"/homepage/doedit",
          data:{openid:openid,id:id,title:title,content:content,img:imghidden,sketch:sketch,type:type},
          type:'post',
