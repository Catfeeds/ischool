...
<div class="row edit-user-row" onclick="urlload()">
  <div class="col-xs-7 col-xs-offset-2 edit-user-top">
      <i class="fa fa-envelope"></i> 一卡通补卡
  </div>
   <div class="col-xs-2 edit-user-top">
      <i class="fa fa-chevron-right"></i>
  </div>
...
<div class="row edit-user-row" onclick="backto('<?php echo URL_PATH?>/information/editepc?id=<?php echo $stu_id?>')">
  <div class="col-xs-7 col-xs-offset-2 edit-user-top">
      <i class="fa fa-envelope"></i> 一卡通卡号变更
  </div>
   <div class="col-xs-2 edit-user-top">
      <i class="fa fa-chevron-right"></i>
  </div>
...
<div class="row help-row">
  <div class="col-xs-12">
    ...
    <div class="help-row-text">
     点击【班级信息】，查看学生所在班级信息。<br/>点击【取消关注】，不再关注学生所在班级。
    </div>
  </div>
</div>
<script>
    function urlload(){
        window.location.href='/zfend/pay';
    }
</script>
