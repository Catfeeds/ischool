<div class="pull-left" style="margin-left: 10px;width: 70%;min-width: 600px;">
    <div style="background-color: white;padding: 10px 20px;box-shadow: 0 0 2px #ccc;">
        ...
        <div>
<!--            <button class="btn btn-xs zd_btn1"><a href="/teacher/fabudt?id=--><?//=$info[0]['id'];?><!--">编辑</a></button>-->
<!--            <button class="btn btn-xs zd_btn2"><a href="/teacher/deldongtai?id=--><?//=$info[0]['id'];?><!--">删除</a></button>-->
        </div>
    </div>
</div>
</div>
