...
<?php foreach($gonggao_edit as  $k=>$v){?>
<!-- <foreach name="gonggao_edit" item="vo" key="key">-->
          ...
          complete:function(XHR, TS)
          {
            ...
            else if (XHR.readyState == 4)
            {
              ...
              if  ((XHR.status >= 200) && (XHR.status <300)) 
              {
                ...
                setTimeout(function () {
                  window.location.replace(path+"/gonggao/index?token=gh_1570853a2962&openid="+openid+"&sid="+sid);
                }, 2000); 
