    ...
    <?php }else{?>       
     <?php foreach($list_cards as $k=>$v){?>
           <div class="col-xs-12 register-user-center-margin" style="margin-top:20px">
               ...
               <div class="row examine-user-list stuinfo-day" onmouseover="register_user_over(this)" onmouseout="register_user_out(this)" id="list<?php echo $v['day']?>     " onclick="witchInfo(this)">
