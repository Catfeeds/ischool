...
<div class="pull-left" style="margin-left: 10px;width: 70%;min-width: 600px;">
    <div style="background-color: white;padding: 10px 20px;box-shadow: 0 0 2px #ccc;">
        <ul class="nav nav-pills clearfix">
            <li>
                <h4 class="pull-left" style="margin-right: 40px;">群组交流</h4>
            </li>
...
//            if (r!=null) return unescape(r[2]); return null;    //原始的中文出现乱码
    ...
    function shouxinpa(){
        ...
        window.location.href = "/teacher/qunzu?type="+type+"&types=shouxin";
    }

    function yifapa(){
        var url = window.location.href;
        window.location.href = "/teacher/qunzu?type="+type+"&types=yifa";
    }
    function xiexinpa(){
        var url = window.location.href;
        window.location.href = "/teacher/qunzu?type="+type+"&types=xiexin";
    }
