...
//
//初始化日志
$logHandler= new CLogFileHandler("/tmp/weixinbuka".date('Y-m-d').'.log');
...
$input->SetNotify_url(WxPayConfig::APP_PAY_URL."notifybk.php");
            ...
            WeixinJSBridge.invoke(
                ...
                function(res){
                    ...
                    if(res.err_msg == 'get_brand_wcpay_request:ok'){
                        alert("支付成功");
                        window.location.href = "<?php echo WxPayConfig::REDIRECT_URLZ?>?openid=<?php echo $opid;?>";
