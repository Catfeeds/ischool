...
<!--               <foreach name="list_stu" item="vo" key="key">-->
    <?php foreach($list_stu as $k=>$v ){?>  
                   <div id="s{$vo.id}" class="col-xs-12 register-user-center-margin">
                       ...
                       <div class="row examine-user-list stuinfo-day" onmouseover="register_user_over(this)" onmouseout="register_user_out(this)" id="list{$vo.id}" onclick="witchInfo(this)">
                           <div class="col-xs-8 text-center">
<!--                               {$vo.ctime|date='Y年m月d日H时i分s',###}-->
                         <?php echo date('Y年m月d日H时i分',$v['ctime'])?>
                           </div>
                           <div class="col-xs-2 text-center"><?php echo $v['info']?></div>
                           <div class="col-xs-2 text-center"><?php echo $v['name']?></div>
                       </div>
       ...
       <div class="row register-user-container">
           ...
           <div class="col-xs-12 register-user-center-margin">
               <div class="row register-user-Paging">
                 <div class="col-sm-2 list-display">记录：<?php echo $stunum?>位学生</div>
