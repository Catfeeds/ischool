...
<!--                    <a href="/teacher/fabudt" class="btn btn-success pull-right">发布</a>-->
                </li><?php foreach($dataprovider as $key=>$value){ ?>
                <li class="list-group-item">
                    <a href="/teacher/dongtaimin?id=<?=$value['id']?>" class="text-primary">
