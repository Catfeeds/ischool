...
<script type="text/javascript">
  $(window).bind("scroll",function(){
  	 var zongtop=$(window).height()
     var top=$(this).scrollTop();//当前窗口的滚动距离
     if(top==0){
     	$("#record-waper").css("top",zongtop-350+"px");
     	$("#uloadfile-waper").css("top",zongtop-250+"px");
     }else{
      $("#record-waper").css("top",zongtop-350+parseFloat(top)+"px");
      $("#uloadfile-waper").css("top",zongtop-250+parseFloat(top)+"px");
     }
  })
  function getone(){
