           ...
           <?php }else{?>
			...
			foreach ($list_user as $key=>$vo) { ?>
               <div id="s<?php echo $vo['id']?>" class="col-xs-12 register-user-center-margin">
                   ...
                   <div class="row register-user-title data-card" onmouseover="register_user_over(this)" onmouseout="register_user_out(this)" id="list<? echo $vo['id'] ?>" onclick="witchInfo(this)">
