...
<html>
	...
	<body>
		...
		<form role="form" id="formjf" action="/zfend/redirectxfpay" method="post">
		    ...
		    <div class="jine" style="padding-left:2rem">
		    	缴费金额
          <?php if($sid=='56758'){?>
          <input type="text" value="750" placeholder="请输入缴费金额" name="total" id="total" disabled/>
          <?php }else{?> 
          ...
          <?php }?>
		    ...
		    <div class="text-center">
		    	<button id="jfbtn" type="button" onclick="jiaofei()" class="btn btn-default">立即缴费</button>
                    ...
                    <input type="hidden" id="type" value="学费">
        </form>
	</body>
</html>
<script>
