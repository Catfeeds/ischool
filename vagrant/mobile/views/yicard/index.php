...
<!--        	<empty name="alertmsg">        -->
          		您的孩子 <font><?php  echo $alert?>  </font> 掌上学校业务将于<?php  echo $enddate?>  到期，请进入正梵智慧校园公众号 点击 家校互动 菜单中的平安通知 根据提示进行缴费 。也可交给班主任代收。缴费后您的学生在有效期内将享受在学校免费给您及绑定的亲情号码（可绑定5个亲情号）拨打电话（不限时长），您及绑定的亲情号码可以收到孩子进出学校（进出宿舍）的通知（请提醒学生佩戴学生证并规范使用）。若未缴费，自<?php  echo $enddate?>  起将不再享受上述服务，但可免费享受家校沟通服务。若有疑问请咨询人工客服或电话（037155030687）咨询。
<!--        	<else/>-->
                <?php }else{?>
        		<?php  echo $alertmsg?>  
<!--        	</empty>-->
