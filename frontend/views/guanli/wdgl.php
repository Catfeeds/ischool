...
<div class="pull-left" style="margin-left: 10px;width: 70%;min-width: 600px;">
    <div style="background-color: white;padding: 10px 20px;box-shadow: 0 0 2px #ccc;">
        <ul class="nav nav-pills clearfix">
            <li>
                <h4 class="pull-left" style="margin-right: 40px;"  id="wendgl">文档管理</h4>
            </li>
                ...
                <table class="table table-bordered text-center" style="margin-top: 20px;">
                    ...
                    <?php  if(!empty($info['inboxlist'])) {
                        ...
                        <tr>
                            ...
                            <td><a style="color: #36ADFF;" href="/guanli/upload?name=<?=$value['title']?>&url=<?=$value['url']?>&time=<?=time()?>">下载</a> </td>
                        </tr>
                    <?php  } ?></table>
                    <?php
            ...
            <div id="yifa" class="tab-pane">
                <div class="panel-group" id="Yfaccordion">
                    <table class="table table-bordered text-center" style="margin-top: 20px;">
                        ...
                        foreach ($info['outboxlist'] as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?=$value['title']?></td>
                                <td><?=date("Y-m-d H:i:s",$value['create_time']);?></td>
                                <td id="<?=$value['id']?>"><a style="color: #36ADFF;" href="/guanli/upload?name=<?=$value['title']?>&url=<?=$value['url']?>&time=<?=time()?>">下载</a>
                    ...
                    <?php
                            ...
                            ]);}else{?> <tr><td colspan="4">您还没有发送过信息！</td></tr></table> <?php }?>
...
//            if (r!=null) return unescape(r[2]); return null;    //原始的中文出现乱码
    ...
    function shouxinpa(){
        ...
        window.location.href = "/guanli/wdgl?type="+type+"&types=shouxin";
    }

    function yifapa(){
        var url = window.location.href;
        window.location.href = "/guanli/wdgl?type="+type+"&types=yifa";
    }
    function xiexinpa(){
        var url = window.location.href;
        window.location.href = "/guanli/wdgl?type="+type+"&types=xiexin";
    }
