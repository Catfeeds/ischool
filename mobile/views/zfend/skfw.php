...
<header>
   ...
   <?php if($ckpass==0){?> 
  <div class="car">水卡：家长可通过该平台或学校管理员给学生充值，充值后，学生凭学生卡可以在学校刷卡用水。家长可实时收到学生的消费情况，也可查询学生的消费记录</div>
    <div class="tishi">
        <span>提示</span>
        <hr style="border: 1px solid #e9e9e9">
        <p>该业务需要学生开通水卡服务【功能支付->校园消费】即可使用。</p>
    </div>
   <?php }else{?> 
<div class="query-area">
    <div class="input-item">
        <label for="starttime">开始时间：</label>
        <input type="text" id="starttime" class="text-input" value="<?= date("Y-m-d",time()-86400*7)?>" disabled >
    </div>
    <div class="input-item">
