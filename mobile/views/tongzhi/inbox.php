       ...
       <div id="list<?php echo $v['id']?>" class="row register-user-container panel-default">
           <div class="col-xs-12 register-user-center-margin">
               ...
               <?php }else{ ?>   
                  <?php echo $v['content']?>
                    <?php if($v['date']=='fail'){?>  
                      <div class="col-xs-12" id="inbox-play-waper">
              ...
              <div class="row" style="margin-bottom:20px;">
                  ...
                  <div class="col-xs-2">
                    <a href="<?php echo URL_PATH?>/exchange/sendmsg?outopenid=<?php echo $v['outopenid']?>&type=back" onclick="loadHtml(this,event);sendMsg()">
                        <span class="badge time-badge reply_span badge_oprate" value="<?php echo $v['id'] ?>  ">回复</span>
                    </a>
                  </div>
                     <div class="col-xs-2">
                      <a href="<?php echo URL_PATH?>/exchange/sendmsg?id=<?php echo $v['id'] ?>&type=transmit" onclick="loadHtml(this,event);sendMsg()">
...
<script>
$(function(){
  $('a[rel="nofollow"]').css('color','black');
})
 function del(id){
    var mid = id;     
    var path=$("#path").val();
          var url=path+'/tongzhi/deleinbox';
          var para={mid: mid};
          var ths = $(this);
          var d = dialog({
            title: '提示',
