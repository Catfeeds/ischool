...
<!--  <if condition="$role eq 1">  班主任显示，其他教师不显示-->
    ...
    <div class="row edit-user-row" data-target="#myModal" data-toggle="modal" onclick="forwardTo(#)">
      <div class="col-xs-7 col-xs-offset-2 edit-user-top">
         <i class="fa fa-envelope-o"></i> 文档管理
      </div>
      <div class="col-xs-2 edit-user-top">
          <i class="fa fa-chevron-right"></i>
      </div>
...
<div style="margin-top:40%;width:80%;margin-left:10%;" class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
               ...
               <?php if($arr_group[0]!=""){?>
                    ...
                    <ul class="form-group text-center" style="max-height:100px;overflow:auto;"> 
                       <?php for($i=0;$i<count($arr_group);$i++){?>   
                        <a style="width:100%;display:block;margin-top:5px;" class="btn bt btn-primary" href="/information/document?qunzu=<?=$arr_group[$i]?>"><span style="padding-right:5px;" class="glyphicon glyphicon-user"></span><?= $arr_group[$i]?></a>
                        <?php }?>
                    </ul>
